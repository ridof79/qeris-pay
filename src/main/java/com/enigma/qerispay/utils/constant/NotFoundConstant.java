...
public class NotFoundConstant {
    ...
    public static final String NO_QR_CODE = "There is no QR code in the image";
    public static final String FILE_NOT_FOUND = "File not found with id %s";
    public static final String USER_NOT_FOUND_CONS = "User not found";
}
