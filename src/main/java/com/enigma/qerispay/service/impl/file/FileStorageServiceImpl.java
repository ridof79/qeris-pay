package com.enigma.qerispay.service.impl.file;
...
public class FileStorageServiceImpl implements FIleStorageService {
    ...
    public File getFileFromDb(String id) throws IOException {
        FileStorage fileStorage = fileStorageRepository.findById(id).orElseThrow(() -> new FileNotFoundException(String.format(NotFoundConstant.FILE_NOT_FOUND, id)));
